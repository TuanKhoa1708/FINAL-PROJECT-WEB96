...
function AdminSidebar() {
  ...
  const items = [
    ...
    {
      key: "people",
      label: <span style={{ fontSize: 11, fontWeight: 600, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: 0.8 }}>People</span>,
      type: "group",
      children: [
    ...
    },
    {
      ...
      children: [
        ...
        { key: "/admin/grades",        icon: <TrophyOutlined />,   label: "Grade Monitor" },
      ],
    },
    {
      key: "tools",
      ...
      type: "group",
      children: [
        { key: "/admin/upload-teachers", icon: <UploadOutlined />, label: "Upload Teachers" },
      ],
    },
  ];
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32, padding: "0 20px" }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 10, color: "var(--color-text-muted)", fontWeight: 500, letterSpacing: 0.5, textTransform: "uppercase" }}>Admin Portal</div>
        </div>
      </div>
