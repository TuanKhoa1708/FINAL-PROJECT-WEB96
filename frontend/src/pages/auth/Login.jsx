    ...
    try {
      ...
      if (foundUser) {
        const finalUser = {
          ...foundUser,
          id:
            foundUser.referenceId?._id ||
            foundUser.referenceId ||
            foundUser._id,
        };

        if (foundUser.role === "teacher") {
          finalUser.subject = foundUser.referenceId?.specialization || "Math";
        }
  ...
  if (success) {
    return (
      <div className="login-success-overlay">
        ...
        <h2
          style={{ color: "white", margin: 0, fontSize: 22, fontWeight: 700 }}
        >
          Welcome back!
        </h2>
