...
function TeacherDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const res = await apiFetch("/teacher/dashboard/stats");
    ...
    <div>
      ...
      >
        ...
        <Text style={{ color: "rgba(255,255,255,0.8)", fontSize: 15 }}>
          Subject:{" "}
          <Tag color="white" style={{ color: "#059669", fontWeight: 700 }}>
            {user?.subject || "—"}
          </Tag>
          ...
          <div className="premium-card" style={{ padding: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                {
                  label: "Manage Scores",
                  sub: "View & update grades for your class",
                  to: "/teacher/scores",
                  color: "#6366F1",
                  bg: "#EEF2FF",
                ...
                {
                  label: "My Schedule",
                  sub: "View your weekly teaching timetable",
                  to: "/teacher/schedule",
                  color: "#10B981",
                  bg: "#F0FDF4",
                  icon: <CalendarOutlined />,
                },
                {
                  ...
                  sub: "Import student list from Excel",
                  to: "/teacher/upload",
                  color: "#F59E0B",
                  bg: "#FFFBEB",
                  icon: <TeamOutlined />,
                },
                {
                  ...
                  sub: "Post learning materials for students",
            ...
            {upcomingClasses.length === 0 ? (
              <div className="empty-state" style={{ padding: 30 }}>
                ...
                <div className="empty-sub">
                  Contact admin to be added to classes.
                </div>
              </div>
            ) : (
              <div
                ...
                {upcomingClasses.map((cls, i) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {cls.subject || user?.subject} · {cls.day} · {cls.time}
                      </div>
                    </div>
                    <Tag
                      color="success"
