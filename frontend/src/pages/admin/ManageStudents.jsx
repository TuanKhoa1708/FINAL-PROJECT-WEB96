...
function ManageStudents() {
    ...
    try {
      if (editingUser._id) {
        ...
        const normalized = {
          ...
          class: updated.classId?.className || editingUser.class,
        };
        setUsers(
        ...
        setUsers([
          ...users,
          {
            ...
            class: created.classId?.className || editingUser.class,
          },
        ]);
  ...
  const columns = [
    ...
    },
    {
      ...
      filters: [...new Set(users.map((u) => u.class).filter(Boolean))].map(
        (c) => ({ text: c, value: c }),
      ),
      ...
      render: (text) =>
        text ? (
          <Tag
            color={CLASS_COLORS[text] || "default"}
          ...
          >
            {[
              ...
              { label: "Class", key: "class", placeholder: "e.g. 10A1" },
              {
                label: "Email",
                key: "email",
                placeholder: "e.g. student@akademi.edu",
              },
